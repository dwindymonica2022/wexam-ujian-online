...
<section class="content-header">
	<h1>
		Pengaturan WEXAM CBT
		<small>Melakukan pengaturan Identitas WEXAM CBT</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url(); ?>/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Pengaturan WEXAM CBT</li>
	</ol>
</section>
			...
			<?php echo form_open($url.'/simpan','id="form-pengaturan"'); ?>
                <div class="box">
                    <div class="box-header with-border">
    					<div class="box-title">Daftar Pengaturan WEXAM CBT</div>
                    </div><!-- /.box-header -->
