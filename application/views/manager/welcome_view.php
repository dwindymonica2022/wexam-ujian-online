...
<section class="content-header">
    <h1>
        Selamat Datang
        <small> di Halaman Login Administrator Wexam: <?php if(!empty($site_name)){ echo $site_name; } ?></small>
    </h1>
</section>
...
<section class="content">
    <div class="callout callout-info">
        <h4>Informasi</h4>
        <p>
            Selamat datang di Halaman Login Aplikasi WEXAM : Computer Based-Test. Untuk memulai silahkan melakukan 
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Login Operator Wexam</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
